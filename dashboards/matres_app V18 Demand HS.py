            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Div(
                        className="demand-table-card",
                        children=[
                            html.H3("Table 1.2: Demand LBE IYA"),
                            dcc.Loading(
                                DataTable(
                    ...
                    html.Div(
                        className="demand-table-card",
                        children=[
                            html.H3("Table 1.3: Demand HS IYA"),
                            dcc.Loading(
                                DataTable(
                    ...
                    html.Div(
                        className="demand-table-card demand-table-card--full",
                        children=[
